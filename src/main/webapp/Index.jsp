...
.hero { background-image: url('https://t3.ftcdn.net/jpg/04/78/18/56/240_F_478185633_LFONOfVamaxmRur4aobZI6MigA9c15Jf.jpg '); background-size: cover;background-position: center; height: 500px;display: flex;align-items: center;justify-content: center;text-align: center; }
...
<div style="border: 1px  ;height: 45px; background-color: ">
	<div>
        <a><img src="https://1000logos.net/wp-content/uploads/2022/12/Jana-Sena-Logo-768x432.jpg" style="height: 30px;
        	margin-top: 5px;text-align: justify;margin-left: 50px;" alt="logo"/> </a>
        <span style="margin-left: 230px;font: bold;font-size: 25px;color: orange;">BLINKS </span>
        <span style="font: bold;font-size: 20px;">TRAINING INSTITUTE-THE UNIT OF TEAM - </span>
        <span style="font: bold;font-size: 20px;color: red;">PUSHPA </span>
        <a href="AdminLogin.jsp" style="text-decoration: none; margin-left: 350px;">ADMIN</a>
        </div>
</div>
...
<div class="navbar">
  	...
  	<a href="LoginPage.jsp"><i class="fa fa-fw "></i>LOGIN</a> 
  	...
  	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm0pSRqKxgsTobfBWesu_fCwwE9vvL1BISvg&usqp=CAU"  alt="logo"/ style="height: 60px;
        margin-top: 5px;margin-left: 100px; border-bottom-left-radius: 30px;">
...
<h1 style="color: blue;font-size: 40px;text-align: center;" >${msg}</h1>

<marquee style="background: linear-gradient(to right, #FA4B37, #DF2771); margin-top: 50px;" direction="left"   scrollamount="10">
...
<section class="hero">
		<div class="hero-content">
			<h2>Welcome to BLINKS COACHING CENTER</h2>
	...
	<footer>
		<div class="footer-container">
			<div class="left-col">
				...
				<p class="rights-text">Copyright © 2023 Created By Team Four and half All Rights Reserved.</p>
				<br><p><img src="">@Hey_info solutions<br>Rajajinagar, Banagalore-560056</p><br>
				<p><img src=""> +91-9741-***-269<br><img src="">&nbsp; pavankumarj1997@gmail.com</p>
			</div>
			<div class="right-col">
