...
<nav class="navbar">
	...
	<h1 style="text-align: center; font-size: 40px; color: white;">LIST OF ALL STUDENTS </h1>
	...
	<c:forEach var="student" items="${students}">
			<tr style="background-color: pink;">
				...
				<th>${student.isStatus()}</th>
				<th><a href=""><button style=" width: 100%;">Delete</button></a></th>
				<th><a href="?id=${student.getId()}"><button style=" width: 100%;">EDIT</button></a></th>
				<th><a href="changestudentstatus?id=${student.getId()}"><button style=" width: 100%;">Change Status</button></a></th>
			</tr>
		</c:forEach>
		</table><br><br>
</body>
